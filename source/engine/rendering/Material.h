...
public:
    ...
    bool tryGetTexture2D(const TextureName& textureName, TextureID& outTex) { return tryGet(textureName, m_textures2D, outTex); }
    bool tryGetTexture3D(const TextureName& textureName, TextureID& outTex) { return tryGet(textureName, m_textures3D, outTex); }
    ...
    const glm::vec2& getVector2(const UniformName& uniformName) noexcept { return m_vec2Map[uniformName]; }
    const glm::vec3& getVector3(const UniformName& uniformName) noexcept { return m_vec3Map[uniformName]; }
    const glm::vec4& getVector4(const UniformName& uniformName) noexcept { return m_vec4Map[uniformName]; }
    const glm::vec3& getColor3(const UniformName& uniformName) noexcept { return m_vec3Map[uniformName]; }
    const glm::vec4& getColor(const UniformName& uniformName) noexcept { return m_vec4Map[uniformName]; }
    const glm::mat2& getMatrix2(const UniformName& uniformName) noexcept { return m_mat2Map[uniformName]; }
    const glm::mat3& getMatrix3(const UniformName& uniformName) noexcept { return m_mat3Map[uniformName]; }
    const glm::mat4& getMatrix4(const UniformName& uniformName) noexcept { return m_mat4Map[uniformName]; }

    bool tryGetFloat(const UniformName& uniformName, float& outVal) noexcept { return tryGet(uniformName, m_floatMap, outVal); }
    bool tryGetVector2(const UniformName& uniformName, glm::vec2& outVal) noexcept { return tryGet(uniformName, m_vec2Map, outVal); }
    bool tryGetVector3(const UniformName& uniformName, glm::vec3& outVal) noexcept { return tryGet(uniformName, m_vec3Map, outVal); }
    bool tryGetVector4(const UniformName& uniformName, glm::vec4& outVal) noexcept { return tryGet(uniformName, m_vec4Map, outVal); }
    bool tryGetColor3(const UniformName& uniformName, glm::vec3& outVal) noexcept { return tryGet(uniformName, m_vec3Map, outVal); }
    bool tryGetColor(const UniformName& uniformName, glm::vec4& outVal) noexcept { return tryGet(uniformName, m_vec4Map, outVal); }
    bool tryGetMatrix2(const UniformName& uniformName, glm::mat2& outVal) noexcept { return tryGet(uniformName, m_mat2Map, outVal); }
    bool tryGetMatrix3(const UniformName& uniformName, glm::mat3& outVal) noexcept { return tryGet(uniformName, m_mat3Map, outVal); }
    bool tryGetMatrix4(const UniformName& uniformName, glm::mat4& outVal) noexcept { return tryGet(uniformName, m_mat4Map, outVal); }
...
private:
    ...
    bool tryGet(const std::string& name, MapT& map, T& outVal)
    {
